...
load(){
    if(localStorage.getItem('markers')=== null || localStorage.getItem('retardoRed')=== null  || localStorage.getItem('idModulador')=== null || localStorage.getItem('modo')=== null
     || localStorage.getItem('estan')=== null || localStorage.getItem('seleccionadoManual')=== null){
            ...
            var modo = ["Dinámico","Dinámico","Dinámico","Dinámico"];
            ...
            var seleccionadoManual = "Tx1";
            var transmisorCercano = true;
            var seleccionManual = false;
            var seleccionadoManual2 = "Tx1";
            var transmisorCercano2 = true;
            var seleccionManual2 = false;
