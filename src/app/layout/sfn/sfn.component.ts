...
@Component({
    selector: 'app-sfn',
    templateUrl: './sfn.component.html',
    styleUrls: ['./sfn.component.scss'],
    providers: [MarkersService,ModuladorService,RemuxService ]
})


export class SfnComponent implements OnInit {

Deltas : any = this._markerService.getDeltasRx1();
alturaIntGua : any = this._moduladorService.obteneralturaIntGua();

intGua =  this._moduladorService.obtenerIntGua();
public lineChartData:any[] =  [
    { label: 'IG',data : [{x: this.intGua ,y:this.alturaIntGua.toFixed(2),}, {x: this.intGua,y: 0}], borderDash : [ 60 , 5]},
...
public lineChartColors: Array<any> = [
 ...
 //CHART PARA RX2
 alturaIntGua2 : any = this._moduladorService.obteneralturaIntGua2();
 public lineChartData2:any[] =  [
    { label: 'IG',data : [{x: this.intGua ,y: this.alturaIntGua2.toFixed(2),}, {x: this.intGua,y: 0}], borderDash : [ 60 , 5]},
...
public lineChartColors2: Array<any> = [
  ...
  public lineChartType2: string = 'scatter';
        ...
        constructor( private _markerService:MarkersService ,private _moduladorService:ModuladorService,private _remuxService:RemuxService ) { 
            ...
            this.alturaIntGua  = this._moduladorService.obteneralturaIntGua();
            this.alturaIntGua2  = this._moduladorService.obteneralturaIntGua2();
            this.seleccionadoManual = this._markerService.obtenerSeleccionadoManual();
            this.transmisorCercano = this._markerService.obtenerTransmisorCercano();
            this.seleccionManual = this._markerService.obtenerSeleccionManual();
            this.seleccionadoManual2 = this._markerService.obtenerSeleccionadoManual2();
            this.transmisorCercano2 = this._markerService.obtenerTransmisorCercano2();
            this.seleccionManual2 = this._markerService.obtenerSeleccionManual2();
        }
        ngOnInit() {
    ...
    seleccionadoManual : string [] ;
    seleccionadoManual2 : string [] ;
    seleccionManual  ;
    seleccionManual2  ;
    transmisorCercano ;
    transmisorCercano2 ;
     ...
     ventanaSincro() {
        ...
        this.calculoDistanciasRx1()
          ...
          //   this.alturaIntGua = this._moduladorService.obteneralturaIntGua();)
             ...
             var NuevasDistanciasRx1 : any = DistanciaRx1;
             var MaximaDistancia : number = 0 ;
             for(let i=0;i<=3; i++){
                if(this['tra'+i] === false){
                     NuevasDistanciasRx1[i] =0;
                     NuevasDistanciasRx1[i+4]=0;
                }
                else if(this['tra'+i] === true && this.obst === false){
                    NuevasDistanciasRx1[i+4]=0;
                 }
                 else{}
             }
             MaximaDistancia = Math.max(NuevasDistanciasRx1[0],NuevasDistanciasRx1[1],NuevasDistanciasRx1[2]
                ,NuevasDistanciasRx1[3],NuevasDistanciasRx1[4],NuevasDistanciasRx1[5]
            ,NuevasDistanciasRx1[6],NuevasDistanciasRx1[7]);
            this.alturaIntGua = MaximaDistancia;
            this._moduladorService.actualizarAlturaIntGua(this.alturaIntGua);
                ...
                let temp = [{  label: this.nombreEstacion[0]    ,data : [{x: this.Deltas[0],y: DistanciaRx1[0].toFixed(2),}, {x: this.Deltas[0],y: 0}]},
                { label: this.nombreEstacion[1],data : [{x: this.Deltas[1],y: DistanciaRx1[1].toFixed(2)}, {x: this.Deltas[1],y: 0}]},
                { label: this.nombreEstacion[2],data : [{x: this.Deltas[2],y: DistanciaRx1[2].toFixed(2)}, {x: this.Deltas[2],y: 0}],},
                { label: this.nombreEstacion[3],data : [{x: this.Deltas[3],y: DistanciaRx1[3].toFixed(2)}, {x: this.Deltas[3],y: 0}]},
                { label: this.nombreEstacion[0]+'-CR',data : [{x: this.Deltas[4],y: DistanciaRx1[4].toFixed(2)}, {x: this.Deltas[4],y: 0}]},
                { label: this.nombreEstacion[1]+'-CR',data : [{x: this.Deltas[5],y: DistanciaRx1[5].toFixed(2)}, {x: this.Deltas[5],y: 0}]},
                { label: this.nombreEstacion[2]+'-CR',data : [{x: this.Deltas[6],y: DistanciaRx1[6].toFixed(2)}, {x: this.Deltas[6],y: 0}]},
                { label: this.nombreEstacion[3]+'-CR',data : [{x: this.Deltas[7],y: DistanciaRx1[7].toFixed(2)}, {x: this.Deltas[7],y: 0}]},
                ]
  ...
  ventanaSincro2() {
   ...
   var DeltaCR : any = [ this.Deltas[4], this.Deltas[5], this.Deltas[6], this.Deltas[7]];
    ...
    var NuevasDistanciasRx2 : any = DistanciaRx2;
    var MaximaDistancia : number = 0 ;
    for(let i=0;i<=3; i++){
       if(this['tra'+i] === false){
        NuevasDistanciasRx2[i] =0;
        NuevasDistanciasRx2[i+4]=0;
       }
       else if(this['tra'+i] === true && this.obst === false){
        NuevasDistanciasRx2[i+4]=0;
        }
    ...
    MaximaDistancia = Math.max(NuevasDistanciasRx2[0],NuevasDistanciasRx2[1],NuevasDistanciasRx2[2]
       ,NuevasDistanciasRx2[3],NuevasDistanciasRx2[4],NuevasDistanciasRx2[5]
   ,NuevasDistanciasRx2[6],NuevasDistanciasRx2[7]);
   this.alturaIntGua2 = MaximaDistancia;
   this._moduladorService.actualizarAlturaIntGua2(this.alturaIntGua2);
       ...
       let temp = [{  label: this.nombreEstacion[0],data : [{x: this.Deltas[0],y: DistanciaRx2[0].toFixed(2),}, {x: this.Deltas[0],y: 0}]},
       { label: this.nombreEstacion[1],data : [{x: this.Deltas[1],y: DistanciaRx2[1].toFixed(2)}, {x: this.Deltas[1],y: 0}]},
       { label: this.nombreEstacion[2],data : [{x: this.Deltas[2],y: DistanciaRx2[2].toFixed(2)}, {x: this.Deltas[2],y: 0}]},
       { label: this.nombreEstacion[3],data : [{x: this.Deltas[3],y: DistanciaRx2[3].toFixed(2)}, {x: this.Deltas[3],y: 0}]},
       { label: this.nombreEstacion[0]+'-CR',data : [{x: this.Deltas[4],y: DistanciaRx2[4].toFixed(2)}, {x: this.Deltas[4],y: 0}]},
       { label: this.nombreEstacion[1]+'-CR',data : [{x: this.Deltas[5],y: DistanciaRx2[5].toFixed(2)}, {x: this.Deltas[5],y: 0}]},
       { label: this.nombreEstacion[2]+'-CR',data : [{x: this.Deltas[6],y: DistanciaRx2[6].toFixed(2)}, {x: this.Deltas[6],y: 0}]},
       { label: this.nombreEstacion[3]+'-CR',data : [{x: this.Deltas[7],y: DistanciaRx2[7].toFixed(2)}, {x: this.Deltas[7],y: 0}]},
       ]
...
mod(){
  ...
  cambioModo(value, id){
    ...
    cambioSeleccionManual(value){
            this._markerService.actualizarSeleccionadoManual(value);
    }

    modoOperacionVentana1(evento, id){
       
        if(id == "seleccionManual") {
            if (evento === true){
                this.transmisorCercano = !evento;
                this._markerService.actualizarTransmisorCercano(this.transmisorCercano);
                this._markerService.actualizarSeleccionManual(evento);
            }else{}
        }
        if(id == "transmisorCercano") {
            if (evento === true){
                this.seleccionManual = !evento;
                this._markerService.actualizarSeleccionManual(this.seleccionManual);
                this._markerService.actualizarTransmisorCercano(evento);
            }else{}
        }
    }

    cambioSeleccionManual2(value){
        this._markerService.actualizarSeleccionadoManual2(value);
}

modoOperacionVentana2(evento, id){
    if(id == "seleccionManual2") {
        if (evento === true){
            this.transmisorCercano2 = !evento;
            this._markerService.actualizarTransmisorCercano2(this.transmisorCercano2);
            this._markerService.actualizarSeleccionManual2(evento);
        }else{}
    }
    if(id == "transmisorCercano2") {
        if (evento === true){
            this.seleccionManual2 = !evento;
            this._markerService.actualizarSeleccionManual2(this.seleccionManual2);
            this._markerService.actualizarTransmisorCercano2(evento);
        }else{}
    }
}
